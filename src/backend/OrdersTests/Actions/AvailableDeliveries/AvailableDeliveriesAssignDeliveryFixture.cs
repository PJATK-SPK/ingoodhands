...
{
    public static class AvailableDeliveriesAssignDeliveryFixture
    {
        ...
        public static Delivery CreateDelivery(bool isDelivered, Warehouse warehouse, long deliveryNameNumber, Order order, TestsToolkit toolkit)
        {
