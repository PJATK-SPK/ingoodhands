...
namespace DonateTests.Actions.GetScore
{
    [TestClass()]
    public class GetScoreTest
    {
        ...
        [TestMethod()]
        public async Task GetScoreTest_OneDonationMultipleProducts_ReturnsScore()
        {
        ...
        [TestMethod()]
        public async Task GetScoreTest_TwoDonationsSomeProducts_ReturnsScore()
        {
            using var toolkit = new TestsToolkit(_usedModules);
            var context = toolkit.Resolve<AppDbContext>();
            var action = toolkit.Resolve<GetScoreAction>();
        ...
        [TestMethod()]
        public async Task GetScoreTest_OneDonationNotDelivered_Returns0()
        {
            using var toolkit = new TestsToolkit(_usedModules);
            var context = toolkit.Resolve<AppDbContext>();
            var action = toolkit.Resolve<GetScoreAction>();
