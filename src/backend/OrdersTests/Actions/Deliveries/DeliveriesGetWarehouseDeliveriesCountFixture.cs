...
{
    public static class DeliveriesGetWarehouseDeliveriesCountFixture
    {
        ...
        public static Order CreateOrder2(TestsToolkit toolkit)
        {
            var builder = toolkit.Resolve<OrderNameBuilderService>();
            ...
            var order2 = new Order
            {
                ...
                OrderProducts = new List<OrderProduct>
                {
                    new OrderProduct
                    {
                        UpdateUserId = UserSeeder.ServiceUser.Id,
                        UpdatedAt = DateTime.UtcNow,
                        ProductId = ProductSeeder.Product20Helmet.Id,
                        Quantity = 550
                    },
                    new OrderProduct
                    {
                        UpdateUserId = UserSeeder.ServiceUser.Id,
                        UpdatedAt = DateTime.UtcNow,
                        ProductId = ProductSeeder.Product21BulletproofVest.Id,
                        Quantity = 550
                    },
                    new OrderProduct
                    {
                        UpdateUserId = UserSeeder.ServiceUser.Id,
                        UpdatedAt = DateTime.UtcNow,
                        ProductId = ProductSeeder.Product26MilitaryUniform.Id,
                        Quantity = 550
                    },
                    new OrderProduct
                    {
