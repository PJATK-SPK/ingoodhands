...
{
    [TestClass()]
    public class PostPickupDonationActionTest
    {
        ...
        [TestMethod()]
        public async Task PerformDonateActionTest_PickupDonation_ChangeIsDeliveredToTrue()
        {
            ...
            var user1 = PostPickupDonationActionFixture.CreateUser("Normal", "User", WarehouseSeeder.Warehouse1PL.Id);
        ...
        [TestMethod()]
        public async Task PerformDonateActionTest_PickupDonation_NoWarehouseId_ThrowsException()
        {
            using var toolkit = new TestsToolkit(_usedModules);
            var context = toolkit.Resolve<AppDbContext>();
            var action = toolkit.Resolve<PostPickupDonationAction>();
            ...
            // Arrange
            var donationNumber = "DNT000001";
            var user1 = PostPickupDonationActionFixture.CreateUser("Normal", "User");
            var auth0User1 = PostPickupDonationActionFixture.CreateAuth0User(user1, 1);
            var userRole1 = PostPickupDonationActionFixture.CreateUserRole(user1, RoleSeeder.Role4WarehouseKeeper.Id);
            var donation1 = PostPickupDonationActionFixture.CreateDonation(false, donationNumber);
        ...
        [TestMethod()]
        public async Task PerformDonateActionTest_PickupDonation_NoDonationName_ThrowsException()
        {
            using var toolkit = new TestsToolkit(_usedModules);
            var context = toolkit.Resolve<AppDbContext>();
            var action = toolkit.Resolve<PostPickupDonationAction>();
            ...
            var auth0User1 = PostPickupDonationActionFixture.CreateAuth0User(user1, 1);
            var userRole1 = PostPickupDonationActionFixture.CreateUserRole(user1, RoleSeeder.Role4WarehouseKeeper.Id);
            var donation1 = PostPickupDonationActionFixture.CreateDonation(false, "DNT000001");
        ...
        [TestMethod()]
        public async Task PerformDonateActionTest_PickupDonation_IsDeliveredTrue_ThrowException()
        {
            using var toolkit = new TestsToolkit(_usedModules);
            var context = toolkit.Resolve<AppDbContext>();
            var action = toolkit.Resolve<PostPickupDonationAction>();
            ...
            var auth0User1 = PostPickupDonationActionFixture.CreateAuth0User(user1, 1);
            var userRole1 = PostPickupDonationActionFixture.CreateUserRole(user1, RoleSeeder.Role4WarehouseKeeper.Id);
            var donation1 = PostPickupDonationActionFixture.CreateDonation(true, donationNumber);
